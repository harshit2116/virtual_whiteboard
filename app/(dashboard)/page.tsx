          ...
          <div className="px-6 -mt-6 relative z-20">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="group relative">
                ...
                <div className="relative bg-white/90 backdrop-blur-sm p-6 rounded-2xl border border-white/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-3xl font-black text-slate-900 mb-1">{activeBoardCount}</p>
              ...
              <div className="group relative">
                ...
                <div className="relative bg-white/90 backdrop-blur-sm p-6 rounded-2xl border border-white/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-3xl font-black text-slate-900 mb-1">{teamMemberCount}</p>
                  ...
                  <div className="mt-4 flex items-center text-green-600">
                    ...
                    <span className="text-sm font-semibold">From organization</span>
                  </div>
                </div>
              </div>
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-r from-amber-400 to-orange-500 rounded-2xl blur opacity-25 group-hover:opacity-40 transition-opacity"></div>
                <div className="relative bg-white/90 backdrop-blur-sm p-6 rounded-2xl border border-white/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-3xl font-black text-slate-900 mb-1">2.4h</p>
                      <p className="text-slate-600 font-semibold">Avg Session</p>
                    </div>
              ...
              <div className="group relative">
                ...
                <div className="relative bg-white/90 backdrop-blur-sm p-6 rounded-2xl border border-white/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-3xl font-black text-slate-900 mb-1">+23%</p>
                      <p className="text-slate-600 font-semibold">Productivity</p>
                    </div>
                  ...
                  <div className="mt-4 flex items-center text-purple-600">
                    <TrendingUp className="h-4 w-4 mr-1" />
                    <span className="text-sm font-semibold">Demo trend</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="px-6 mt-12">
            <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 border border-white/50 shadow-2xl">
              <div className="flex items-center justify-between mb-8">
                <div>
                  <h2 className="text-2xl font-black text-slate-900 mb-2">Your Workspace</h2>
                  <p className="text-slate-600">Manage and collaborate on your projects</p>
                </div>
                <div className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full text-white font-semibold">
